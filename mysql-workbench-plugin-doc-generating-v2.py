...
ModuleInfo = DefineModule("ModelDocumentation", author="Hieu Le", version="1.0.0", description="Generate AsciiDoc v6 documentation from a model")

# This plugin takes no arguments
@ModuleInfo.plugin("info.hieule.wb.documentation", caption="Generate documentation (AsciiDoc v5)", description="description", input=[wbinputs.currentDiagram()], pluginMenu="Utilities")
